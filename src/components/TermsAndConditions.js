const TermsAndConditions = () => {
    ...
    return (
        <div className="bg-yellow-50 p-5 rounded-lg my-5 shadow-md max-w-screen-md mx-auto">
            <h2 className="text-center text-gray-800 text-xl font-semibold mb-5">भाग लेने से पहले जानें</h2>
            <div className="flex flex-col md:flex-row justify-between gap-5">
                
                {sections.map((section, index) => (
                    <div key={index}>
                        <h3 className="text-gray-700 font-medium mb-3">{section.title}</h3>
