  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-200">
      <div className="w-full max-w-sm bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-center text-2xl font-semibold mb-6 text-black">Admin Login</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="userId" className="block text-gray-700">Enter ID</label>
            <input
              type="text"
              id="userId"
              name="userId"
          ...
          {errorMsg && <p className="text-red-500 mb-6">Invalid Id & Password</p>}
          <button
            type="submit"
